...
include "include/ac3_lugares.php";
...
<body>
    <div class="container m-o content-justify-center px-2">
        ...
        <div class="row text-center">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <input type="text" name="descripcin" class="form-control" placeholder="Descripcion" required>
        </div>
            </div>

        <div class="row text-center">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <textarea name="tel" class="form-control" placeholder="Telefono"></textarea>
        </div>
            </div>
